...
mkValidator beneficiary datum _ ctx = traceIfFalse "Giver invalid" (signedByBeneficiary && giverDeadlinePassed)
  where
    info :: TxInfo
    ...
    giverDeadlinePassed = contains (from $ datum) $ txInfoValidRange info-- FIX ME!
